...
<head>
    ...
    <h1 class="w3-center w3-black w3-round-large w3-margin">Atualizar Livros: <?php echo " ".$_GET['id']?> </h1>
    <form action="AtualizarLivrosActionBD.php" class="w3-container" method='post'>
        ...
        <label class="w3-text-white w3-padding" style="font-weight: bold; background-color: black; display: inline-block; width: 25%; padding: 10px;">Editora</label>
        <input name="txtEdtora" class="w3-input w3-light-grey w3-border" value="<?php echo $_GET['editora']?>">
        <br>
        ...
        <label class="w3-text-white w3-padding" style="font-weight: bold; background-color: black; display: inline-block; width: 25%; padding: 10px;">Paginas</label>
