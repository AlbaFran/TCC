...
<div class="w3-padding w3-content w3-text-grey w3-third w3-display-middle" >
    <?php
       require_once 'conexaoBD.php';
        ...
        $sql = "UPDATE cadastro SET nome = '".$_POST['txtNome']."', telefone = '".$_POST['txtTelefone']."',
        email='".$_POST['txtEmail']."', email = '".$_POST['txtEmail']."', CPF = '".$_POST['txtCPF']."', senha = '".$_POST['txtSenha']."' WHERE idcadastro =". $_POST['txtID'].";";
